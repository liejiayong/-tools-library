(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CanvasScraping"] = factory();
	else
		root["CanvasScraping"] = factory();
})(window, function() {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./dist/canvas-scraping.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "../../../../../nvm/v10.16.3/node_modules/webpack/buildin/global.js":
/*!***********************************!*\
...
var _fill = _interopRequireDefault(__webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/instance/fill */ "./node_modules/@babel/runtime-corejs3/core-js-stable/instance/fill.js"));
...
__webpack_require__(/*! @/lib/simulateTouch.js */ "./lib/simulateTouch.js");
...
/*#__PURE__*/
function () {
  function CanvasScraping() {
    var element = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    var config = arguments.length > 1 ? arguments[1] : undefined;
    (0, _classCallCheck2["default"])(this, CanvasScraping);
    var DEFAULT_CONFIG = {
      width: 300,
      // canvas 宽
      height: 150,
      ...
      unit: 'px',
      // 宽高css单位
      containerClass: 'scraping-container',
      // 装载刮卡的父元素类名
    ...
    this.first = true;
    var pixelRatio = this.config.pixelRatio > 1 ? this.config.pixelRatio : 1;
  ...
  (0, _createClass2["default"])(CanvasScraping, [{
    key: "_readyCB",
    value: function _readyCB() {
    ...
    value: function clear() {
      ...
      if (duration >= 0) {
        ...
        var transition = this._preStyle('transition');

        var canvas = this.ctx.canvas;
        canvas.style[transition] = "all ".concat(duration / 1000, "s linear");
    ...
    value: function setBG() {
      ...
      this._loadImg(url).then(function (_ref) {
        ...
        _this2.ctx.drawImage(image, left, top, width, height);
    ...
    key: "setAward",
    value: function setAward() {
      var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.config.awardImg;
      this.container.style.backgroundImage = "url(\"".concat(url, "\")");
    }
    /**
     * 设置刮刮卡封面
     */
    ...
    value: function setCover() {
      var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.config.coverImg;
      this.ctx.canvas.style.opacity = '1'; // 图层背景
    ...
    key: "_createAward",
    value: function _createAward() {
      var _context, _context2, _context3;

      var parentEl = document.createElement('div');
      var _this$config = this.config,
          awardCssText = _this$config.awardCssText,
          width = _this$config.width,
          height = _this$config.height,
          unit = _this$config.unit,
          containerClass = _this$config.containerClass;
      awardCssText += (0, _concat["default"])(_context = (0, _concat["default"])(_context2 = (0, _concat["default"])(_context3 = ";width:".concat(width)).call(_context3, unit, ";height:")).call(_context2, height)).call(_context, unit, ";background: url(\"\") no-repeat center / contain;");
    ...
    key: "_resetBounding",
    value: function _resetBounding() {
      var b = this.container.getBoundingClientRect();
      this.offsetLeft = b.left;
      this.offsetTop = b.top; // console.log('getBoundingClientRect', b, this.offsetLeft, this.offsetTop)
    }
  }, {
    key: "_drawPoint",
    value: function _drawPoint(_ref2) {
      var _context4;
      ...
      (0, _fill["default"])(_context4 = this.ctx).call(_context4);
      this.ctx.restore();
    }
  }, {
    key: "_pixelPercent",
    value: function _pixelPercent() {
      var pixelData = this.ctx.getImageData(0, 0, this.width, this.height).data,
    ...
    key: "_getPostion",
    value: function _getPostion(touches) {
      if (!touches || touches && !touches.clientX) return {
        x: 0,
        y: 0,
        radius: 0
      };
      var _this$config3 = this.config,
          pixelRatio = _this$config3.pixelRatio,
          radius = _this$config3.radius; // let x = (touches.clientX + document.body.scrollLeft || touches.pageX) - this.offsetLeft || 0,
      // y = (touches.clientY + document.body.scrollTop || touches.pageY) - this.offsetTop || 0

      var x = touches.clientX - this.offsetLeft,
          y = touches.clientY - this.offsetTop; // console.log('touches', x, y, this.offsetLeft, this.offsetTop)

      x = Math.abs(x) * pixelRatio;
      y = Math.abs(y) * pixelRatio; // console.log(touches, x, y)
    ...
    key: "_judgeArea",
    value: function _judgeArea() {
      var percent = this.config.percent;

      var currPercent = this._pixelPercent();
    ...
    key: "_preStyle",
    value: function _preStyle(style) {
    ...
    key: "_extend",
    value: function _extend(defOption, extOption) {
      if ('assign' in Object) {
        return (0, _assign["default"])(defOption, extOption);
      }

      for (var key in extOption) {
        if (defOption[key]) {
      ...
      return new _promise["default"](function (resolve, reject) {
        try {
          ...
          img.onerror = function () {
            return reject(new Error('Image loading fail.'));
          };
        } catch (error) {
          reject(error);
        }
    ...
    value: function _event() {
      ...
      this.ctx.canvas.addEventListener('touchstart', (0, _bind["default"])(_context5 = this._eventDown).call(_context5, this), {
        passive: false
      });
      this.ctx.canvas.addEventListener('touchmove', (0, _bind["default"])(_context6 = this._eventMove).call(_context6, this), {
        passive: false
      });
      this.ctx.canvas.addEventListener('touchend', (0, _bind["default"])(_context7 = this._eventUp).call(_context7, this), {
        passive: false
      });
      this.ctx.canvas.addEventListener('touchcancel', (0, _bind["default"])(_context8 = this._eventUp).call(_context8, this), {
        passive: false
      });
      this.ctx.canvas.addEventListener('touchleave', function () {
        var _context9;

        return (0, _bind["default"])(_context9 = _this3._eventUp).call(_context9, _this3);
      }, {
        passive: false
      });
    }
    ...
    key: "_eventMove",
    value: function _eventMove(e) {
      e.preventDefault();
      if (this.lock) return;

      if (this.isDown && !this.done) {
        var _this$_getPostion = this._getPostion(e.changedTouches[0]),
            x = _this$_getPostion.x,
            y = _this$_getPostion.y,
            radius = _this$_getPostion.radius;
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../../../../../nvm/v10.16.3/node_modules/webpack/buildin/global.js */ "../../../../../nvm/v10.16.3/node_modules/webpack/buildin/global.js")))
...
module.exports = JSON.parse("{\"name\":\"canvas-scraping\",\"version\":\"1.0.0\",\"description\":\"babel Template\",\"main\":\"canvas-scraping.js\",\"scripts\":{\"watch\":\"babel lib --out-dir dist --watch\",\"compiler\":\"babel lib/canvas-scraping.js --out-dir dist\",\"build\":\"webpack --config webpack.config.js\"},\"keywords\":[\"babel\",\"tamplate\"],\"author\":\"liejiayong\",\"license\":\"MIT\",\"dependencies\":{\"@babel/runtime-corejs3\":\"^7.7.6\",\"babel-loader\":\"^8.1.0\",\"core-js\":\"^3.4.8\"},\"devDependencies\":{\"@babel/cli\":\"^7.7.5\",\"@babel/core\":\"^7.7.5\",\"@babel/plugin-transform-arrow-functions\":\"^7.7.4\",\"@babel/plugin-transform-runtime\":\"^7.7.6\",\"@babel/preset-env\":\"^7.7.6\",\"@babel/runtime\":\"^7.7.6\"}}");
