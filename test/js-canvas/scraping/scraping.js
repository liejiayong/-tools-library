...
class Scraping {
	...
	_createAward() {
		...
		let { awardCssText, width, height, unit, containerClass, awardImg } = this.config
	...
	_eventMove(e) {
		...
		if (this.isDown) {
			...
			console.log(touches.clientX, touches.clientY, x, y, pixelRatio, radius)
			this.ctx.beginPath()
...
var scraping = new Scraping(card, {
