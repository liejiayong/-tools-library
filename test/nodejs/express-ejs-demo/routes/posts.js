...
router.get('/', function (req, res, next) {
  ...
  PostModel.getPosts(author).then(function (posts) {
    res.render('posts', { blog: { title: '文章' }, posts: posts })
  }).catch(next)
})
...
router.get('/:postId', function (req, res, next) {
  ...
  Promise.all([
    ...
    res.render('post', { blog: { title: post.title }, post: post, comments: comments, user: user })
  }).catch(next)
})
...
router.get('/:postId/edit', checkLogin, function (req, res, next) {
  ...
  PostModel.getRawPostById(postId).then(function (post) {
    ...
    res.render('edit', { blog: { title: '编辑文章' }, post: post })
  }).catch(next)
})
