...
AlTER TABLE `jy_blog_articles`
MODIFY `views` bigint(20) NOT NULL  DEFAULT 0  COMMENT '文章浏览量'
...
,MODIFY `create_date` DATETIME NULL DEFAULT NULL COMMENT '发表时间'
,MODIFY `update_date` DATETIME NULL DEFAULT NULL COMMENT '更新时间';AlTER TABLE `jy_blog_articles` ADD `tags` varchar(255) NOT NULL DEFAULT '' COMMENT '标签'
